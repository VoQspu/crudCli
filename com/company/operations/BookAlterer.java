...
public class BookAlterer implements Operationable {
    ...
    public void performAction() {
        ...
        try {
            ...
            Optional<Book> optionalBook = SearchUtility.findElementById(books, choice);
    ...
    private void changeAuthor(Scanner scanner, Book book) throws AuthorNotFoundException {
        ...
        Author author = SearchUtility.findElementById(authors, Integer.parseInt(scanner.nextLine()))
